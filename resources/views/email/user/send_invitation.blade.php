                ...
                <tbody>
                    <tr>
                        <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                            {{emailSetting('send_invitation_email')->hello??'Hello'}}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                           {!! emailSetting('send_invitation_email')->first_part??'' !!} {{ $data['name']??'' }} {!! $setting->second_part?? ' ' !!}
                        </td>
                    </tr>

                    @if(emailSetting('send_invitation_email')->image??'')
                    <tr>
                       <td style="padding: 15px 24px 15px; color: #8492a6;">
                    ...
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            {{emailSetting('send_invitation_email')->team??'Team'}}
                        </td>
                    </tr>
