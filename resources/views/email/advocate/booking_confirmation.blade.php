                ...
                <tbody>
                    <tr>
                        <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                            {{emailSetting('advocate_booking_email')->hello??''}}
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            {!! emailSetting('advocate_booking_email')->desc??'' !!}
                        </td>
                    </tr>

                    @if(emailSetting('advocate_booking_email')->image??'')
                    <tr>
                       <td style="padding: 15px 24px 15px; color: #8492a6;">
                    ...
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            {{emailSetting('advocate_booking_email')->team??''}}
                        </td>
                    </tr>
