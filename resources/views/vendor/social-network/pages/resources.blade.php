    ...
    <div class="col-lg-12 col-12">
        ...
        <div class="card">
            <div class="card-body main-clickable-links">
                ...
                <span class="text-center" data-toggle="modal" data-target="#eventModal"><i class="fas fa-plus bg-primary text-white add_event_icon "></i></span>
                @endif
            </div>
        </div>
        ...
        <div class="col-sm-12 mb-2 card p-1">
            <div class="media">
                <div class="media-body post-feed-section pt-0">
                    <button
                        class=" btn-post btn-block text-primary font-weight-bold border-0 popover-button input-type" data-value="Resources">
