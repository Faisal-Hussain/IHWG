...
@section('heading','Advocate Booking Confirmation Email')
@section('css')
<style>
.bg-orange{
...
@section('content')
    @php
        $setting=$setting['advocate_booking_email']??'';
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="post" action="{{route('admin.email.save')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="advocate_booking_email" name="email_type">
