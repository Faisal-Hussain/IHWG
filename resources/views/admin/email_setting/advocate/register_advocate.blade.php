...
@section('heading','Register Advocate Email')
@section('css')
<style>
.bg-orange{
...
@section('content')
    @php
        $setting=$setting['register_advocate']??'';
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="post" action="{{route('admin.email.save')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="register_advocate" name="email_type">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <strong class="text-info">Contant Body of Email:</strong>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <h3 id="subject">{!! $setting->subject??'' !!}</h4>
                                    <br>
