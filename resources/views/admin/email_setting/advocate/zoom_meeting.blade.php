...
@section('heading','Zoom Meeting Link Email')
@section('css')
    <style>
        .bg-orange{
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><span id="dear">{{$setting->dear??''}} </span><span class="font-weight-bold">Name of meeting member</span> <span id="first">{!! $setting->first_part??'' !!} </span><span id="name" class="font-weight-bold"> Name of Event</span>
                                        <br>
                                        <span id="second"> {!! $setting->second_part??'' !!}</span></p>
