...
@section('heading','Booking Confirmation Email')
@section('css')
<style>
.bg-orange{
...
@section('content')
    @php
        $setting=$setting['booking_confirmation_email']??'';
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="post" action="{{route('admin.email.save')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="booking_confirmation_email" name="email_type">
