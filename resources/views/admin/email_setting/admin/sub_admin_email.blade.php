...
@section('heading','Sub Admin Email')
@section('css')
<style>
.bg-orange{
...
@section('content')
    @php
        $setting=$setting['sub_admin_email']??'';
        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="post" action="{{route('admin.email.save')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="sub_admin_email" name="email_type">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><span id="first">{!! $setting->first_part??'' !!} </span><span id="name" class="font-weight-bold">Name</span><span id="second"> {!! $setting->second_part??'' !!}</span></p>
                                    <button type="button" class="btn btn-primary text-center mt-1 mb-1">Go To Dashboard</button>
                                    @if($setting->image??'')
