                    ...
                    <div class="m-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons main-nav-links">
                            ...
                            <li class="nav-item d-none d-lg-block text-center">
                                <a class="nav-link @routeis('user.dashboard') active-menu @endrouteis" href="{{ route('user.dashboard') }}" data-toggle="tooltip" data-placement="top" title="Dashboard">
                            ...
                            <li class="nav-item d-none d-lg-block text-center">
                                <a class="nav-link @routeis('advocate.social.network') active-menu @endrouteis" href="{{ route('social.index') }}" data-toggle="tooltip" data-placement="top" title="Social Platform">
