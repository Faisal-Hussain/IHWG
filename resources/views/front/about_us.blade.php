...
@include('front.components.pages_banner', ['heading' => $setting['about_title'] ?? '', 'description' => $setting['about_description'] ?? ''])
    ...
    <div id="custom_single_page">
        <div class="container">
            ...
            <div class="col-sm-6 p-0">
                <img alt="" src="{{ asset($setting['about_section_1st_thumbnail'] ?? '')  }}" class="w-100 p-3">
            </div>
        </div>

        <div class="row dr card-site rounded mt-5">
            <div class="col-sm-6 p-0">
                <img alt="" src="{{ asset($setting['about_section_2nd_thumbnail'] ?? '')  }}" class="w-100 p-3">
            </div>
            <div class="col-sm-6 m-auto">
                <div class="text-center">
        ...
        <div class="row card-site rounded mt-5">
            ...
            <div class="col-sm-6 p-0">
                    <img alt="" src="{{ asset($setting['about_section_3rd_thumbnail'] ?? '')  }}" class="w-100 p-3">
            </div>
    </div>

    <div class="row dr card-site rounded mt-5">
        <div class="col-sm-6 p-0">
            <img alt="" src="{{ asset($setting['about_section_4th_thumbnail'] ?? '')  }}" class="w-100 p-3">
        </div>
        <div class="col-sm-6 m-auto">
            <div class="text-center">
