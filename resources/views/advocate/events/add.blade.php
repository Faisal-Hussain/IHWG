...
@section('content')
<form method="POST" action="{{ route('advocate.events.store') }}" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="append-date-time">
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <label>Date</label>
                                        <input type="text" class="form-control datepicker date" name="date[]" required="" value="{{ now()->addDay()->format('Y-m-d') }}">
                                    </div>
                                    <div class="col-sm-6">
